# Spring Boot JdbcTemplate example with Oracle: Build CRUD Rest API
Build a Spring Boot CRUD Rest API example that uses Spring Data Jdbc to make CRUD Operations with Oracle Database. You'll know:
- How to configure Spring Data to work with Oracle database
- How to define Data Models and Repository interfaces
- Way to create Spring Rest Controller to process HTTP requests
- Way to use JdbcTemplate to interact with Database

For instruction, please visit:
> [Spring Boot JdbcTemplate and Oracle example](https://www.bezkoder.com/spring-boot-jdbctemplate-example-oracle/)
